...
export class NotificationService {
  ...
  markAllAsRead(): Observable<number> {
    return this.http.put<number>(`${this.baseUrl}/read-all`, {});
  }
  ...
  sendRecruiterMessage(request: RecruiterMessageRequest): Observable<NotificationResponse> {
    return this.http.post<NotificationResponse>(`${this.baseUrl}/messages/recruiter`, request);
  }
}

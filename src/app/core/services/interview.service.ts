...
export interface CandidateRescheduleRequest {
...
export class InterviewService {
  ...
  confirmInterview(interviewId: number): Observable<InterviewResponse> {
    return this.http.put<InterviewResponse>(`${this.baseUrl}/${interviewId}/candidate/confirm`, {});
  }

  requestReschedule(
    interviewId: number,
    request: CandidateRescheduleRequest
  ): Observable<InterviewResponse> {
    return this.http.put<InterviewResponse>(`${this.baseUrl}/${interviewId}/candidate/reschedule`, request);
  }

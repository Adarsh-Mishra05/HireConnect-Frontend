...
export class JobService {
  ...
  getSavedJobs(): Observable<JobResponse[]> {
    return this.http.get<JobResponse[]>(`${this.jobsBaseUrl}/bookmarks/me`);
  }

  saveJob(jobId: number): Observable<string> {
    return this.http.post(`${this.jobsBaseUrl}/${jobId}/bookmark`, {}, { responseType: 'text' });
  }

  removeSavedJob(jobId: number): Observable<string> {
    return this.http.delete(`${this.jobsBaseUrl}/${jobId}/bookmark`, { responseType: 'text' });
  }
